...
// Actividad 1: Paralelización con #pragma omp parallel for + reduction
//
// Ecuación: ∇²V = 4
// Dominio:  x ∈ [1, 2],  y ∈ [0, 2]
//
...
//
// Compilación:
//   g++ -O2 -fopenmp -o poisson_parallel_for poisson_parallel_for.cpp
//
// Ejecución:
//   ./poisson_parallel_for
//   OMP_NUM_THREADS=4 ./poisson_parallel_for   (controlar número de threads)
// =============================================================================
...
// -----------------------------------------------------------------------------
// solve_poisson  —  VERSIÓN ACTIVIDAD 1: parallel for + reduction
//
...
int main()
{
    ...
    std::cout << "============================================\n";
    std::cout << "  Poisson 2D — Ejemplo 3 (Actividad 1)\n";
    std::cout << "  Directiva: parallel for + reduction\n";
    ...
    export_to_file(V, h, k, M, N, "solucion_parallel_for.dat");
